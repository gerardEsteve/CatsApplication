...
public class CatListAdapter extends RecyclerView.Adapter<CatListAdapter.CatViewHolder> {
    ...
    @NonNull
    @Override
    public CatListAdapter.CatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CatListAdapter.CatViewHolder holder, final int position) {
        ...
        if(mCats != null ) {
            ...
            if(mCats.get(position).getDownloaded()){
               ...
               OkHttpHandlerImages okHttpHandler= new OkHttpHandlerImages(mCats.get(position).getImageID(),position,this);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("country_code",mCats.get(position).getCountry_code());
